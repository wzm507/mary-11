...
const ContactSection = () => {
  ...
  return (
    <div className="bg-gray-900 py-20 px-4 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row gap-12">
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold mb-6 text-white">{t('contactSection')}</h2>
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-center">
              ...
              <span className="text-gray-300">{t('featuredListings')}</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-300">{t('servicePhilosophy')}</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-300">{t('propertyDevelopers')}</span>
            </div>
          </div>
